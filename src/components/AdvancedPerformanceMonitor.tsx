...
const AdvancedPerformanceMonitor: React.FC = () => {
    ...
    const toggleMonitoring = async () => {
        ...
        try {
            if (!isMonitoring) {
                await axios.post(`${API_BASE_URL}/performance/start-monitoring`);
                fetchPerformanceMetrics(); // 즉시 데이터 수집
            } else {
                await axios.post(`${API_BASE_URL}/performance/stop-monitoring`);
            }
        } catch (err) {
    ...
    const resolveAlert = async (alertId: string) => {
        try {
            await axios.post(`${API_BASE_URL}/performance/alerts/${alertId}/resolve`);
    ...
    const exportData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/performance/export`, {
