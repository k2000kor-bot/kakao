...
const ProjectDashboard: React.FC<ProjectDashboardProps> = ({
  ...
  useEffect(() => {
    ...
    const calculateStats = () => {
      ...
      const totalKnowledge = project.guidelines.length; // 지식 베이스 항목 수
      
      // 완성도 계산 (예시)
      const completionRate = Math.min(100, Math.round((totalFiles + totalKnowledge) * 10));
  ...
  useEffect(() => {
    ...
    // 최근 지식 (최근 3개)
    setRecentKnowledge(project.guidelines.slice(0, 3));
  }, [project]);
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.totalKnowledge}</p>
            </div>
          ...
          <div className="mt-4">
            <div className="flex items-center text-sm">
              ...
              <span className="text-blue-600">AI 생성 지식 포함</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">파일 업로드</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">AI 학습</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">지식 베이스</span>
          </button>
          
          <button
            onClick={() => onNavigateToSection('chats')}
            className="flex flex-col items-center p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-orange-500 hover:bg-orange-50 transition-colors"
          >
