...
const RealEstateDataPanel: React.FC<RealEstateDataPanelProps> = ({
  ...
  return (
    <div className="real-estate-data-panel">
          ...
          <div className="search-section">
            ...
            <div className="search-row">
              ...
              <select
                ...
                onChange={(e) => setSearchParams({ ...searchParams, transactionType: e.target.value as any })}
              >
          ...
          <div className="search-section">
            ...
            <div className="search-row">
              ...
              <select
                ...
                onChange={(e) => setRegistrySearchParams({ ...registrySearchParams, changeType: e.target.value as any })}
              >
                <option value="">전체</option>
