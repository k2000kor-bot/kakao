...
const AutomationWorkflowManager: React.FC = () => {
    ...
    const loadExecutions = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/automation/executions`);
            if (response.data.success) {
    ...
    const handleExecuteWorkflow = async (workflowId: string) => {
        try {
            const response = await axios.post(`${API_BASE_URL}/automation/workflows/${workflowId}/execute`);
            if (response.data.success) {
                setError(null);
    ...
    const handlePauseWorkflow = async (workflowId: string) => {
        try {
            const response = await axios.post(`${API_BASE_URL}/automation/workflows/${workflowId}/pause`);
            if (response.data.success) {
                setError(null);
                loadWorkflows();
            }
    ...
    const handleResumeWorkflow = async (workflowId: string) => {
        try {
            const response = await axios.post(`${API_BASE_URL}/automation/workflows/${workflowId}/resume`);
            if (response.data.success) {
                setError(null);
                loadWorkflows();
            }
