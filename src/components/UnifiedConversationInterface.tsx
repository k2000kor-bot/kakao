...
import IntegratedMediaFileUpload from './IntegratedMediaFileUpload';
...
const UnifiedConversationInterface: React.FC<UnifiedConversationInterfaceProps> = ({
  ...
  const renderInputForm = () => (
    <div className="space-y-4">
      ...
      {showMediaUpload && (
        <div className="mb-4">
          <IntegratedMediaFileUpload
            onFilesUploaded={handleMediaFilesUploaded}
            onFileAnalyzed={handleFileAnalyzed}
            onAIResponseGenerated={handleAIResponseGenerated}
      ...
      <UniversalChatInput
        ...
        onMediaUpload={(files: File[]) => {
          // 미디어 파일 업로드 처리
          handleMediaFilesUploaded(files.map(file => ({
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <div className="mt-6 text-sm text-gray-500">
                    <p>💡 명령어를 사용해보세요:</p>
                    <p className="mt-2">/help - 사용 가능한 명령어 보기</p>
                    <p>/upload - 파일 업로드</p>
                    <p>/project list - 프로젝트 목록</p>
                  </div>
                </div>
              </div>
            ) : (
