...
const mockMessageHistoryService = messageHistoryService as jest.Mocked<typeof messageHistoryService>;
const mockSearchHistoryService = searchHistoryService as jest.Mocked<typeof searchHistoryService>;
const mockSearchAnalyticsService = searchAnalyticsService as jest.Mocked<typeof searchAnalyticsService>;
const mockAdvancedSearchParser = advancedSearchParser as jest.Mocked<typeof advancedSearchParser>;
