...
const mockProjectTemplateService = projectTemplateService as jest.Mocked<typeof projectTemplateService>;
  ...
  describe('검색 기능', () => {
    ...
    it('검색어로 템플릿을 필터링해야 함', async () => {
      ...
      await waitFor(() => {
        ...
        const templateCards = screen.queryAllByText(/Template/i);
