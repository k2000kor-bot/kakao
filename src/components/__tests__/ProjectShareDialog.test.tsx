...
const mockProjectShareService = projectShareService as jest.Mocked<typeof projectShareService>;
...
describe('ProjectShareDialog', () => {
  ...
  describe('공유 링크 관리', () => {
    ...
    it('링크 삭제 버튼 클릭 시 확인 후 삭제해야 함', () => {
      (window.confirm as jest.Mock).mockReturnValue(true);

      renderWithTheme(<ProjectShareDialog {...defaultProps} />);

      // Delete 아이콘을 가진 버튼 찾기
