...
const mockAnalyzeStyle = jest.fn();
...
describe('WritingQualityPanel', () => {
  ...
  beforeEach(() => {
    ...
    (writingQualityAnalyzer.analyzeStyle as jest.Mock).mockReturnValue(mockStyleAnalysis);
  });
  ...
  describe('점수 색상 및 레이블', () => {
    it('점수가 90 이상이면 "우수" 레이블을 표시해야 함', () => {
      (writingQualityAnalyzer.analyzeQuality as jest.Mock).mockReturnValue({
        ...mockAnalysis,
    ...
    it('점수가 70 이상이면 "보통" 레이블을 표시해야 함', () => {
      ...
      (writingQualityAnalyzer.analyzeStyle as jest.Mock).mockReturnValue({
        ...mockStyleAnalysis,
