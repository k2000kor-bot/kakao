...
const AdvancedSecurityPanel: React.FC = () => {
    ...
    const [newIPBlock, setNewIPBlock] = useState({ ip_address: '', reason: '', severity: 'medium' as const });
                                    ...
                                    <TableRow key={blocked.ip_address}>
                                        ...
                                        <TableCell>
                                            <Chip
                                                ...
                                                color={getSeverityColor(blocked.severity) as any}
                                                size="small"
                                            />
                                        </TableCell>
                ...
                <DialogContent>
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select
                            ...
                            onChange={(e) =>
                                setNewIPBlock({ ...newIPBlock, severity: e.target.value as any })
                            }
                        >
