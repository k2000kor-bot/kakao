...
describe('AIAnalysisEngine', () => {
  ...
  describe('analyzeProject', () => {
    it('프로젝트 분석 수행', async () => {
      ...
      (chatService.getProjectChats as jest.Mock).mockReturnValue(chats);
      (messageService.getChatMessages as jest.Mock).mockReturnValue(messages);
    ...
    it('빈 메시지 프로젝트 분석', async () => {
      ...
      (projectService.getProject as jest.Mock).mockResolvedValue(project);
      (chatService.getProjectChats as jest.Mock).mockReturnValue(chats);
      (messageService.getChatMessages as jest.Mock).mockReturnValue([]);
    ...
    it('여러 채팅이 있는 프로젝트 분석', async () => {
      ...
      (projectService.getProject as jest.Mock).mockResolvedValue(project);
      (chatService.getProjectChats as jest.Mock).mockReturnValue(chats);
      (messageService.getChatMessages as jest.Mock)
