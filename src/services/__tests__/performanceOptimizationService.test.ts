...
describe('PerformanceOptimizationService', () => {
  ...
  describe('성능 메트릭 조회', () => {
    it('성능 메트릭 조회 성공', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith(
        'http://localhost:8004/api/performance/metrics'
      );
    });
  ...
  describe('시스템 건강도 조회', () => {
    it('시스템 건강도 조회 성공', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith(
        'http://localhost:8004/api/performance/health'
      );
    });
  ...
  describe('최적화 권장사항 조회', () => {
    it('최적화 권장사항 조회 성공', async () => {
      ...
      expect(mockedAxios.get).toHaveBeenCalledWith(
        'http://localhost:8004/api/performance/recommendations'
      );
    });
  ...
  describe('최적화 적용', () => {
    it('최적화 적용 성공', async () => {
      ...
      expect(mockedAxios.post).toHaveBeenCalledWith(
        'http://localhost:8004/api/performance/optimize',
        {
          id: 'opt-1',
          type: 'memory',
        }
