...
describe('advancedQualityEvaluator', () => {
  ...
  describe('evaluateResponseQuality', () => {
    ...
    it('프로젝트 컨텍스트를 고려해야 함', async () => {
      const response = '개포우성7차 재개발 프로젝트의 시공사 선정은 중요합니다.';
      const userInput = '시공사 선정에 대해 알려주세요.';
      const context = {
        conversationHistory: [],
        projectContext: {
          projectName: '개포우성7차 재개발',
  ...
  describe('실제 사용자 시나리오 테스트', () => {
    ...
    it('재개발 프로젝트 관련 응답의 품질을 평가할 수 있어야 함', async () => {
      const response = '개포우성7차 재개발 프로젝트의 시공사 선정은 매우 중요한 결정입니다. 기술력, 안전성, 경험, 경제성을 종합적으로 평가해야 합니다. 대우건설은 뛰어난 기술력과 체계적인 안전 관리 시스템을 보유하고 있어 우수한 후보입니다.';
      const userInput = '개포우성7차 재개발 프로젝트 시공사 선정에 대해 알려주세요.';
      const context = {
        conversationHistory: [],
        projectContext: {
          projectName: '개포우성7차 재개발',
