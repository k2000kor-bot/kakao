...
import domainKnowledgeService, { DomainType, DomainKnowledge } from '../domainKnowledgeService';
...
describe('domainKnowledgeService', () => {
  ...
  describe('loadConfig', () => {
    it('저장된 설정을 로드할 수 있어야 함', () => {
      ...
      localStorage.setItem('domainKnowledgeConfig', JSON.stringify(testConfig));
