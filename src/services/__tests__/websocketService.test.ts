...
describe('WebSocketService', () => {
  ...
  describe('이벤트 리스너', () => {
    it('이벤트 리스너 등록', () => {
      ...
      // emit을 통해 테스트
      (service as any).emit('test', { data: 'test' });
...
describe('MetricsWebSocket', () => {
  ...
  beforeEach(() => {
    ...
    jest.advanceTimersByTime(1);
    mockWs = (metricsWs as any).ws as MockWebSocket;
  });
  ...
  it('연결 해제', () => {
    ...
    expect((metricsWs as any).ws).toBeNull();
  });
});
...
describe('AlertsWebSocket', () => {
  ...
  beforeEach(() => {
    ...
    jest.advanceTimersByTime(1);
    mockWs = (alertsWs as any).ws as MockWebSocket;
  });
  ...
  it('연결 해제', () => {
    ...
    expect((alertsWs as any).ws).toBeNull();
  });
});
