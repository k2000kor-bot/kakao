...
class IntelligentResponseService {
   ...
   * 스마트 응답 생성
   */
  async generateSmartResponse(message: string, context?: any): Promise<SmartResponse> {
   ...
   * 고급 의도 분석
   */
  private analyzeAdvancedIntent(message: string): any {
    const patterns = {
   ...
   * 비교 분석 응답
   */
  private generateComparisonResponse(intent: any, context: any): SmartResponse {
    return {
   ...
   * 트렌드 분석 응답
   */
  private generateTrendResponse(intent: any, context: any): SmartResponse {
    return {
   ...
   * 인사이트 응답
   */
  private generateInsightResponse(intent: any, context: any): SmartResponse {
    return {
   ...
   * 추천 응답
   */
  private generateRecommendationResponse(intent: any, context: any): SmartResponse {
    return {
   ...
   * 기본 응답
   */
  private generateDefaultResponse(intent: any): SmartResponse {
    return {
