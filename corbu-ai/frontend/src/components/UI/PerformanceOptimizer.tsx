        ...
        <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 2, mb: 4 }}>
                {metrics.map((metric) => {
                    ...
                    return (
                        <Box key={metric.id} sx={{ width: { xs: '100%', sm: '50%', md: '33.33%' } }}>
                            <Card sx={{ height: '100%' }}>
                                <CardContent>
                                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                                        <IconComponent sx={{ mr: 1, color: getStatusColor(metric.status) }} />
                                        ...
                                        primary={
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                ...
                                                <Chip
                                                    ...
                                                    size="small"
                                                    sx={{
                                                        bgcolor: getImpactColor(suggestion.impact),
                                                        color: 'white',
                                                        fontSize: '0.7rem'
                                                    }}
                                                />
                                                <Chip
                                                    ...
                                                    variant="outlined"
                                                    sx={{
                                                        borderColor: getEffortColor(suggestion.effort),
