...
function contextualAnalysisPostUrl(): string {
  return joinApiHealthCheckUrl(API_BASE_URL || FALLBACK_API_ORIGIN, API_V7_CONTEXTUAL_ANALYSIS_PATH);
}
