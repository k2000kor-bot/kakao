...
import webSearchIntegrationService from '../webSearchIntegrationService';
  ...
  describe('searchAndSynthesize', () => {
    it('기본 검색 쿼리로 통합 응답을 생성할 수 있어야 함', async () => {
      const nlpAnalysis: NLPAnalysisResult = {
        ...
        response_strategy: { detail_level: 'detailed', tone: 'professional', examples_needed: false, code_examples: false, visual_aids: false }
      };
    ...
    it('기술적 쿼리에 대해 검색을 수행할 수 있어야 함', async () => {
      const nlpAnalysis: NLPAnalysisResult = {
        ...
        response_strategy: { detail_level: 'detailed', tone: 'technical', examples_needed: false, code_examples: false, visual_aids: false }
      };
    ...
    it('빈 쿼리에 대해 기본 응답을 반환해야 함', async () => {
      const nlpAnalysis: NLPAnalysisResult = {
        ...
        response_strategy: { detail_level: 'brief', tone: 'friendly', examples_needed: false, code_examples: false, visual_aids: false }
      };
