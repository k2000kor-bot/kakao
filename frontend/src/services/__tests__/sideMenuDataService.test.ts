...
describe('SideMenuDataService', () => {
  ...
  describe('데이터 새로고침', () => {
    it('데이터 새로고침', () => {
      ...
      expect(dataBefore).toHaveProperty('projects');
  ...
  describe('localStorage 데이터 로드', () => {
    it('저장된 최근 파일 로드', () => {
      ...
      localStorageMock.setItem(CORBU_AI_RECENT_FILES_STORAGE_KEY, JSON.stringify(mockFiles));
    ...
    it('저장된 템플릿 로드', () => {
      ...
      localStorageMock.setItem(CORBU_AI_TEMPLATES_STORAGE_KEY, JSON.stringify(mockTemplates));
    ...
    it('저장된 워크플로우 로드', () => {
      ...
      localStorageMock.setItem(CORBU_AI_WORKFLOWS_STORAGE_KEY, JSON.stringify(mockWorkflows));
    ...
    it('저장된 통계 데이터 로드', () => {
      ...
      localStorageMock.setItem(CORBU_AI_STATISTICS_STORAGE_KEY, JSON.stringify(mockStatistics));
  ...
  describe('에러 처리', () => {
    it('잘못된 JSON 데이터 처리', () => {
      localStorageMock.setItem(CORBU_AI_RECENT_FILES_STORAGE_KEY, 'invalid json');
    ...
    it('localStorage 접근 실패 처리', () => {
      ...
      localStorageMock.getItem = jest.fn((_key: string): string | null => {
