...
const SecurityAutomationPanel: React.FC = () => {
    ...
    const handleConfirmDelete = () => {
        if (deleteConfirmRuleId) {
            securityAutomationService.deleteRule(deleteConfirmRuleId);
            loadRules();
    ...
    return (
        <Box sx={{ p: 3 }}>
            ...
            <Dialog open={isDialogOpen} onClose={handleCloseDialog} maxWidth="md" fullWidth>
                            ...
                            <Select
                                ...
                                onChange={(e) =>
                                    setNewRule({
                                        ...
                                        trigger: {
                                            ...newRule.trigger,
                                            type: e.target.value as 'threat' | 'alert' | 'event' | 'metric',
                                        },
                                    })
                                }
                            >
                ...
                <DialogActions>
                    <Button type="button" onClick={handleCloseDialog} aria-label="규칙 편집 취소">취소</Button>
                    <Button type="button" onClick={handleSaveRule} variant="contained" aria-label="규칙 저장">
                        저장
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            >
                <DialogTitle id="delete-dialog-title">규칙 삭제</DialogTitle>
                <DialogContent>
                    <Typography id="delete-dialog-description">
                        이 규칙을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.
                    </Typography>
                </DialogContent>
                <DialogActions>
                    <Button type="button" onClick={handleCancelDelete} autoFocus aria-label="삭제 취소">
                        취소
                    </Button>
                    <Button type="button" onClick={handleConfirmDelete} color="error" variant="contained" aria-label="규칙 삭제 확인">
                        삭제
                    </Button>
                </DialogActions>
            </Dialog>
