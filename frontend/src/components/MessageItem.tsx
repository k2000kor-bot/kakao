...
import { GensparkPipelineExtrasPanel } from './genspark/GensparkPipelineExtrasPanel';
...
const MessageItem: React.FC<MessageItemProps> = ({
    ...
    return (
        <div
            className={`message ${sender} genspark-qa-message`}
            role="article"
                ...
                {isEditing ? (
                    ...
                    <>
                        <div className="genspark-qa-role-row">
                            <span
                                className={`genspark-qa-badge ${sender === 'user' ? 'genspark-qa-badge--question' : 'genspark-qa-badge--answer'}`}
                            >
                                {sender === 'user' ? ASSISTANT_GENSPARK_QA_BADGE_QUESTION : ASSISTANT_GENSPARK_QA_BADGE_ANSWER}
                            </span>
                        </div>
                        <div
                            role="paragraph"
                        ...
                        {sender === 'ai' &&
                            pipelineExtras &&
                            hasPipelineExtras(pipelineExtras) && (
...
const areEqual = (prevProps: MessageItemProps, nextProps: MessageItemProps) => {
    return (
        ...
        prevProps.pipelineExtras === nextProps.pipelineExtras &&
