...
const mockUseResponsive: jest.MockedFunction<typeof useResponsive> = jest.mocked(useResponsive);
...
describe('MobileNavigation', () => {
  ...
  describe('현재 선택된 대화 하이라이트', () => {
    it('현재 선택된 대화가 하이라이트되어야 함', () => {
