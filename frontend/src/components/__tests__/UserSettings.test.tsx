...
const mockUseDarkMode: jest.MockedFunction<typeof useDarkMode> = jest.mocked(useDarkMode);
const mockUseTranslation: jest.MockedFunction<typeof useTranslation> = jest.mocked(useTranslation);
