...
import {
  ...
  INTEGRATED_API_ANALYTICS_INSIGHTS_PATH,
  INTEGRATED_API_ANALYTICS_PREDICTIONS_PATH,
...
function AdvancedAnalytics({ onInsightGenerated }: AdvancedAnalyticsProps) {
  ...
  const runAdvancedAnalysis = async () => {
    ...
    try {
      const response = await fetch(joinApiHealthCheckUrl(resolveApiBaseUrl(), INTEGRATED_API_ANALYTICS_ADVANCED_PATH), {
        method: 'POST',
        headers: {
  ...
  const runPredictionAnalysis = async () => {
    ...
    try {
      const response = await fetch(joinApiHealthCheckUrl(resolveApiBaseUrl(), INTEGRATED_API_ANALYTICS_PREDICTIONS_PATH), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const runInsightsGeneration = async () => {
    ...
    try {
      const response = await fetch(joinApiHealthCheckUrl(resolveApiBaseUrl(), INTEGRATED_API_ANALYTICS_INSIGHTS_PATH), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
