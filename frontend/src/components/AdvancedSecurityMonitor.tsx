...
function AdvancedSecurityMonitor() {
    ...
    const collectSecurityMetrics = useCallback(async () => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(resolveApiBaseUrl(), SECURITY_METRICS_PATH)
            );
    ...
    const updateSecurityEvents = useCallback(async () => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(resolveApiBaseUrl(), SECURITY_EVENTS_PATH)
            );
            const data = await response.json();
    ...
    const updateSecurityPolicies = useCallback(async () => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(resolveApiBaseUrl(), SECURITY_POLICIES_PATH)
            );
            const data = await response.json();
    ...
    const updateAuditLogs = useCallback(async () => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(resolveApiBaseUrl(), SECURITY_AUDIT_PATH)
            );
            const data = await response.json();
    ...
    const runSecurityScan = useCallback(async () => {
        ...
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(resolveApiBaseUrl(), SECURITY_SCAN_PATH),
                {
                    method: 'POST',
                }
            );
    ...
    const resolveThreat = useCallback(async (threatId: string) => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(
                    resolveApiBaseUrl(),
                    `${SECURITY_THREATS_PATH_PREFIX}/${threatId}/resolve`
                ),
                {
                    method: 'POST',
                }
    ...
    const togglePolicy = useCallback(async (policyId: string, status: string) => {
        try {
            const response = await fetch(
                joinApiHealthCheckUrl(
                    resolveApiBaseUrl(),
                    `${SECURITY_POLICIES_PATH}/${policyId}`
                ),
                {
                    method: 'PUT',
