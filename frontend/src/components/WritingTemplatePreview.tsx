        ...
        <div className="template-preview-overlay" onClick={onClose} data-testid="writing-template-preview">
            <div className="template-preview-modal" onClick={(e) => e.stopPropagation()}>
                <div className="preview-header">
                    ...
                    <button type="button" className="close-btn" onClick={onClose} data-testid="preview-close-button" aria-label="미리보기 닫기">
                        ✕
                    </button>
                </div>
                    ...
                    <div className="preview-section">
                        <h4>
                            ...
                            <button
                                ...
                                aria-label={showFullPrompt ? '프롬프트 접기' : '프롬프트 펼치기'}
                            >
                ...
                <div className="preview-actions">
                    <button type="button" className="select-btn" onClick={onSelect} data-testid="preview-select-button" aria-label="이 템플릿 사용하기">
                        이 템플릿 사용하기
                    </button>
                </div>
            </div>
