...
const ConstructionCompanyDashboard: React.FC = () => {
    ...
    const handleCompareCompanies = useCallback(async () => {
        if (selectedCompaniesForComparison.length < 2) {
            showToast('비교할 시공사를 2개 이상 선택하세요.');
            return;
        }
    ...
    return (
        <Box>
                                ...
                                <CardContent>
                                    ...
                                    <Box sx={{ mt: 2 }}>
                                        <Button
                                            ...
                                            onClick={() => {
                                                // 상세 보기는 향후 구현
                                                showToast(`${company.name} 상세 정보는 향후 구현 예정입니다.`, 'info');
                                            }}
                                        >
                                            상세 보기
                                        </Button>
                ...
                <Box sx={{ mb: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                // 이슈 등록 다이얼로그는 향후 구현
                                showToast('이슈 등록 기능은 향후 구현 예정입니다.', 'info');
                            }}
                        >
                            이슈 등록
                        </Button>
            ...
            >
                ...
                <DialogActions>
                    <Button type="button" onClick={() => setIsResponsePlanDialogOpen(false)} aria-label="응답 계획 다이얼로그 닫기">닫기</Button>
                </DialogActions>
            </Dialog>
            ...
            >
                ...
                <DialogActions>
                    <Button type="button" onClick={() => setIsComparisonDialogOpen(false)} aria-label="시공사 비교 다이얼로그 닫기">닫기</Button>
                </DialogActions>
            </Dialog>
        </Box>
    );
