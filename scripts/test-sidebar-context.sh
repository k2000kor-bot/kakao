...
# Jest 외 수동(첨부·재생성·편집): docs/guides/CHAT_UI_TEST_SCENARIOS.md §14.5 · CHAT_ANSWER_FLOW_VERIFICATION.md §8 행 9
set -euo pipefail
...
# Sync mirrored frontend/src and run sidebar-context regression suites (AppUnified·Settings·ChatGPTInterface·sidebarContextFilterEvent).
