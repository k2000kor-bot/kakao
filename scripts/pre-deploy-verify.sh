...
echo "관계도 풀(API+E2E): npm run verify:conversation-graph:full (백엔드 :5002)"
echo "/chat handoff·graph 재생성 unit: npm run test:conversation-graph:chat-handoff"
echo "첨부+짧은 지시 E2E: E2E_COMPOSER_ATTACH_CONTEXT=1 npm run test:e2e:composer-attach-context"
