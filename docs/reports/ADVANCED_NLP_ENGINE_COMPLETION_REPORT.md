...
**프로젝트명**: 샘플 재개발 프로젝트 고급 NLP 엔진 통합  
**개발 기간**: 2025년 8월 15일  
...
```json
{
  "text": "샘플 재개발 프로젝트의 투자 가치를 분석해주세요.",
  "analysis_type": "semantic",
  "context": {
    "domain": "real_estate",
    "previous_texts": ["샘플 재개발에 대해 궁금합니다."]
  }
}
```
...
```json
{
  ...
  "analysis_type": "semantic",
  "result": {
    "surface_meaning": "주요 키워드: 샘플 프로젝트, 재개발, 프로젝트, 투자, 가치",
...
```
사용자: "샘플 재개발 프로젝트의 투자 가치를 분석해주세요."
NLP 엔진: 
- 키워드 추출: "샘플 프로젝트", "재개발", "투자", "가치"
- 감정 분석: 중립적 톤 (0.6)
- 의도 분석: 분석 요구 (0.8)
...
이제 샘플 재개발 프로젝트에 대한 **최상급 성능의 고급 NLP 분석**을 받을 수 있습니다! 🏢🤖
